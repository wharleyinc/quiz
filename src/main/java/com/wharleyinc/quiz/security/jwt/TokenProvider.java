package com.wharleyinc.quiz.security.jwt;
...
public class TokenProvider {
    ...
    @Value("${application.jwtSecret64}")
    private String appSecret64;

    @Value("${application.tokenValidityInSeconds}")
    private long tokenValidityInSeconds;

    @Value("${application.tokenValidityInSecondsForRememberMe}")
...
//    private final ApplicationProperties applicationProperties;
    ...
    public TokenProvider(ApplicationProperties applicationProperties) {
        ...
        if (!ObjectUtils.isEmpty(secret)) {
            ...
            keyBytes = Decoders.BASE64.decode(applicationProperties.getJwtSecret64());
        }
