package com.wharleyinc.quiz.service.mapper;
...
public class UserMapper {
    ...
    public UserDTO toDtoUserName(User user) {
        if (user == null) {
            return null;
        }
        UserDTO userDto = new UserDTO();
    ...
    public Set<UserDTO> toDtoUserNameSet(Set<User> users) {
        if (users == null) {
            return Collections.emptySet();
        }
        ...
        Set<UserDTO> userSet = new HashSet<>();
        for (User userEntity : users) {
            userSet.add(this.toDtoUserName(userEntity));
        }
